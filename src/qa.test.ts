...
import { readSavedModelProto } from "@tensorflow/tfjs-node/dist/saved_model";
...
// describe("QAClient", () => {
//   it.skip("works in spanish", async () => {
//     const t = await readSavedModelProto(
//       "/Users/pierric/DEV/node-transformers/.models/distilbert-base-cased-distilled-squad/"
//     );
//     console.log(t);
...
//     // const result = await qaClient.predict(
//     //   "¿Para qué lenguaje está trabajando?",
...
//     // expect(result.text).toEqual("español");
